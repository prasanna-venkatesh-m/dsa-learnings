...
namespace DSA.SQL
{
    internal class Average_Time_Process_Per_Machine
    {
        //Table: Activity
        ...
        //SELECT
        //fil.machine_id,
        //CAST((fil.timestamp/fil.counts) as DECIMAL(10,3)) as processing_time
        //FROM(
        //    SELECT
        //    machine_id,
        //    COUNT(*)/2 as counts,
        //    SUM(CASE WHEN activity_type = 'end' THEN timestamp ELSE 0 END) -
        //    SUM(CASE WHEN activity_type = 'start' THEN timestamp ELSE 0 END) as timestamp
        //    FROM Activity
        //    GROUP BY machine_id
        //) as fil
